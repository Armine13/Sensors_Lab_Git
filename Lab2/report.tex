...
\begin{figure}[H]
	\centering
	\subfigure[Original\textdegree]{\label{fig:transa}
	\includegraphics[width=\linewidth]{Pictures/Transf.jpg}
	}
	\subfigure[Glass\textdegree]{\label{fig:transb}
	\includegraphics[width=\linewidth]{Pictures/Transf_Glass.jpg}
	}
	\subfigure[PVC\textdegree]{\label{fig:transc}
...
\begin{figure}[H]
	\centering
	\subfigure[Original\textdegree]{\label{fig:fina}
	\includegraphics[width=\linewidth]{Pictures/finger2.jpg}
	}
	\subfigure[Copper-reflect finger\textdegree]{\label{fig:finb}
...
\begin{figure}[H]
	\centering
	\subfigure[Before\textdegree]{\label{fig:holea}
	\includegraphics[width=0.4\linewidth]{Pictures/holes_cropped.jpg}
	}
	\subfigure[After\textdegree]{\label{fig:holeb}
